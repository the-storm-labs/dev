...
export const Information: React.FC = () => {
  ...
  return (
    <InformationContainer>
      <Box sx={{ p: [2, 3] }}>
        <Paragraph sx={{ mt: 2 }}>
          Bonds accrue a virtual balance of boosted IBRL tokens (iBRL) over time. At any time, the
          bonder may choose to claim their iBRL in exchange for their IBRL, or cancel their bond to
          recover their deposited IBRL.
        </Paragraph>
        <Paragraph sx={{ mt: 3 }}>
          Please visit the&nbsp;
