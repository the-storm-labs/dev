...
export const PENDING_BONDS: Lexicon = {
  term: "Pending bonds",
  description: "Your active bonds which are accruing iBRL and can be claimed or cancelled."
};
...
export const NOT_BONDED_YET: Lexicon = {
  ...
  description:
    "You can bond IBRL to obtain Boosted IBRL (iBRL) - a yield-amplified version of IBRL."
};
...
export const BOND_CREATED: Lexicon = {
  term: "Bond created",
  description:
    "The date you created your bond. The iBRL accrual starts at 0 and increases over time."
};
...
export const BREAK_EVEN_TIME: Lexicon = {
  ...
  description:
    "Estimated time at which the bond will have accrued enough iBRL to offset the IBRL cost of the bond, under current market prices."
};

export const OPTIMUM_REBOND_TIME: Lexicon = {
  term: "Rebond time",
  description:
    "Estimated optimum time to claim the bond, sell the iBRL for IBRL, and then bond again, to maximize your return under current market prices."
};

export const REBOND_RETURN: Lexicon = {
  term: `${OPTIMUM_REBOND_TIME.term} return`,
  description: `Estimated return from selling your accrued iBRL to IBRL at the ${OPTIMUM_REBOND_TIME.term}, minus the initial IBRL cost of the bond, under current market prices.`
};

export const REBOND_TIME_ROI: Lexicon = {
  term: `${OPTIMUM_REBOND_TIME.term} ROI`,
  description: `Estimated ROI of selling your accrued iBRL to IBRL at the ${OPTIMUM_REBOND_TIME.term}, minus the initial IBRL cost of the bond, under current market prices.`
};
...
export const OPTIMUM_ACCRUAL: Lexicon = {
  term: "Rebond accrual",
  description: `The required amount of iBRL to accrue for the ${OPTIMUM_REBOND_TIME.term}, under current market prices.`,
...
export const ACCRUED_AMOUNT: Lexicon = {
  term: "Accruing",
  description: "The amount of iBRL this bond has accrued so far."
};

export const MARKET_VALUE: Lexicon = {
  term: "Accrued value",
  description:
    "Current market value of the accrued iBRL. The iBRL market price can fluctuate but will always be higher than the floor price under rational market conditions."
};
...
export const BOND_RETURN: Lexicon = {
  ...
  description:
    "Expected IBRL gained from claiming the bond now and selling the iBRL for IBRL and deducting the initial cost of the bond, under current market prices.",
  link: "https://docs.chickenbonds.org/faq/economic-design#_44lrt4qpho3a"
};
...
export const PENDING_STATUS: Lexicon = {
  term: "Pending",
  description: "An active bond which is accruding iBRL and can be cancelled or claimed."
};
...
export const CANCEL_BOND: Lexicon = {
  term: "Cancel bond",
  description:
    "A bond can be cancelled at any time to recover the initially deposited IBRL amount while forgoing the accrued iBRL.",
...
export const CLAIM_BOND: Lexicon = {
  term: "Claim bond",
  description:
    "A bond can be claimed at any time to forgo the initially deposited IBRL amount and gain the accrued iBRL.",
  link: "https://docs.chickenbonds.org/faq/basic-usage#_2c022erjceom"
};

export const BLUSD_MARKET_PRICE: Lexicon = {
  term: "Market price",
  description: "The current price of iBRL according to the iBRL Curve pool."
};

export const BLUSD_FAIR_PRICE: Lexicon = {
  term: "Fair price",
  description:
    "An estimated range of the market price of iBRL based on the current yield amplification. The lower bound excludes the Pending bucket, the upper bound factors all buckets.",
...
export const BLUSD_SUPPLY: Lexicon = {
  term: "Total supply",
  description: "The total amount of iBRL in circulation. Not including pending bonds accrued iBRL."
};

export const BLUSD_FLOOR_PRICE: Lexicon = {
  term: "Floor price",
  description:
    "The amount of IBRL that an arbitrageur could redeem iBRL for thus creating a lower bound iBRL market price.",
...
export const BLUSD_WIND_DOWN_PRICE: Lexicon = {
  ...
  description:
    "The protocol supports a graceful wind down mechanism for migration purposes, whereby Yearn Finance governance can trigger a special function which moves the Permanent bucket IBRL into the Reserve, thus enabling all iBRL to be redeemed for a higher floor price.",
  link:
...
export const BLUSD_APR: Lexicon = {
  term: "iBRL APR",
  description: "The APR of iBRL, based on the yield generated from each bucket in the Treasury.",
...
export const BLUSD_LP_APR: Lexicon = {
  term: "LP APR",
  description:
    "The APR from providing liquidity to the iBRL/IBRL-3CRV pool. A combination of IBRL rewards from Chicken-in fees and Curve rewards.",
...
export const BLUSD_YIELD_AMPLIFICATION: Lexicon = {
  ...
  description:
    "The iBRL token generates a yield which is a multiple of the Stability Pool yield. It is derived from the total protocol yield which is being diverted to the Reserve bucket.",
...
export const TREASURY_TOTAL: Lexicon = {
  term: "Total",
  description:
    "The total amount of IBRL held by the protocol within the three buckets (Pending, Reserve, Permanent).",
...
export const TREASURY_PENDING: Lexicon = {
  term: "Pending",
  description:
    "Contains the deposited IBRL of the users while they bond. Pending bonds can be claimed or cancelled any time, moving the IBRL into the Reserve and Permanent buckets, or back to the bonder, respectively.",
  link: "https://docs.chickenbonds.org/faq/technical-design#_ydtvzh456fiz"
};
...
export const TREASURY_ACQUIRED: Lexicon = {
  term: "Reserve",
  description:
    "Contains a portion of the IBRL obtained from claimed bonds and captures the yield from the entire Treasury. It acts as a reserve backing the iBRL supply. iBRL can be redeemed for a pro-rata share of the IBRL held in the Reserve bucket.",
  link: "https://docs.chickenbonds.org/faq/technical-design#_ydtvzh456fiz"
};
...
export const TREASURY_PERMANENT: Lexicon = {
  term: "Permanent",
  description:
    "Contains a portion of the IBRL obtained from claimed bonds which contributes a permanent price premium over IBRL. The IBRL in this bucket is not redeemable.",
  link: "https://docs.chickenbonds.org/faq/technical-design#_ydtvzh456fiz"
};

export const ESTIMATES_ONLY_NOTICE = {
  description: "These metrics are estimations based on the current iBRL market price",
  link: "https://docs.chickenbonds.org/faq/economic-design#_lnta1xbq350e"
};

export const INFINITE_ESTIMATION = {
  description:
    "The iBRL market price premium is currently too low to make bonding profitable. Bonds will be profitable again if the premium returns. Buying iBRL from the market currently generates a higher return than bonding.",
  link:
